...
// Set parameters, inputs on posedge
// Evaluate/Sample on negedge
...
if (Y_TB !== 'b0) begin
    $display("%d %m: ERROR - Expected sum of 0. Got: (%0d).", $stime, Y_TB);
    $finish;
end
...
if (Y_TB !== 'h04) begin
    $display("%d %m: ERROR - Expected sum of 4: Got (%0d).", $stime, Y_TB);
    $finish;
end
...
if (Y_TB !== 'h01) begin
    $display("%d %m: ERROR - Expected value of 1: Got (%0d).", $stime, Y_TB);
    $finish;
end
...
if (Y_TB !== 'h20) begin
    $display("%d %m: ERROR - 2 Expected value of 0x20: Got (%0d).", $stime, Y_TB);
    $finish;
end
...
if (Y_TB !== 'hFFF0) begin
    $display("%d %m: ERROR - Expected value of 240: Got (%0d).", $stime, Y_TB);
    $finish;
end
...
if (OFlags_TB[alu_sim.CarryFlag] !== 1'b1 && OFlags_TB[alu_sim.ZeroFlag] !== 1'b1) begin
    $display("%d %m: ERROR - Expected Carry and Zero flags Set too. Got %04b.", $stime, OFlags_TB);
    $finish;
end

if (Y_TB !== 'h0000) begin
    $display("%d %m: ERROR - Expected value of 0: Got (%0d).", $stime, Y_TB);
    $finish;
end
...
if (Y_TB !== 'hFFFE) begin
    $display("%d %m: ERROR - Expected value of 254: Got (%0d).", $stime, Y_TB);
    $finish;
end
...
if (Y_TB !== 'h8000) begin
    $display("%d %m: ERROR - Expected value of 128: Got (%0d).", $stime, Y_TB);
    $finish;
end
...
if (Y_TB !== 'h0003) begin
    $display("%d %m: ERROR - Expected value of 3: Got (%0d).", $stime, Y_TB);
    $finish;
end
